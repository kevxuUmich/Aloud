...
@Suite struct PanelKeysTests {
    @Test func bareKeysMapToTheirActions() {
        ...
        #expect(PanelKeys.action(keyCode: PanelKeys.up, modifiers: []) == .louder)
        #expect(PanelKeys.action(keyCode: PanelKeys.down, modifiers: []) == .quieter)
        #expect(PanelKeys.action(keyCode: PanelKeys.up, modifiers: [.option]) == .faster)
        #expect(PanelKeys.action(keyCode: PanelKeys.down, modifiers: [.option]) == .slower)
    }
    ...
    @Test func arrowsArriveWithTheirOwnFlags() {
        #expect(PanelKeys.action(keyCode: PanelKeys.up, modifiers: [.function, .numericPad]) == .louder)
        #expect(PanelKeys.action(keyCode: PanelKeys.down, modifiers: [.function, .numericPad]) == .quieter)
        #expect(
            PanelKeys.action(keyCode: PanelKeys.up, modifiers: [.function, .numericPad, .option]) == .faster)
    }
    ...
    @Test func modifiedAndOtherKeysAreLeftAlone() {
        ...
        #expect(PanelKeys.action(keyCode: PanelKeys.up, modifiers: [.command]) == nil)
        #expect(PanelKeys.action(keyCode: PanelKeys.space, modifiers: [.option]) == nil)
